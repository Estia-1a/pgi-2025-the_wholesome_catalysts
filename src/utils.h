...
pixelRGB * get_pixel(unsigned char* data, const unsigned int largeur, const unsigned int hauteur, const unsigned int n, const unsigned int x, const unsigned int y);
